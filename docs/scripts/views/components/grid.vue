          ...
          <ui-grid-cell>
            <div class="demo-controls">
              ...
              <ui-select
                ...
                @change="$grid.set('margin', 'desktop', $event)"
              ></ui-select>
              ...
              <ui-select
                ...
                :options="gutterOptions"
                @change="$grid.set('gutter', 'desktop', $event)"
              ></ui-select>
            </div>
          </ui-grid-cell>
          <ui-grid-cell>
            <div class="demo-controls">
              ...
              <ui-select
                ...
                :options="gutterOptions"
                @change="$grid.set('margin', 'tablet', $event)"
              ></ui-select>
              ...
              <ui-select
                ...
                :options="gutterOptions"
                @change="$grid.set('gutter', 'tablet', $event)"
              ></ui-select>
            </div>
          </ui-grid-cell>
          <ui-grid-cell>
            <div class="demo-controls">
              ...
              <ui-select
                ...
                :options="gutterOptions"
                @change="$grid.set('margin', 'phone', $event)"
              ></ui-select>
              ...
              <ui-select
                ...
                :options="gutterOptions"
                @change="$grid.set('gutter', 'phone', $event)"
              ></ui-select>
            </div>
          </ui-grid-cell>
        </ui-grid>
            ...
            <ui-grid-cell>
              <div class="demo-controls">
                ...
                <ui-select
                  ...
                  @change="$grid.set('column-width', 'desktop', $event)"
                ></ui-select>
              </div>
            </ui-grid-cell>
            <ui-grid-cell>
              <div class="demo-controls">
                ...
                <ui-select
                  ...
                  :options="widthOptions"
                  @change="$grid.set('column-width', 'tablet', $event)"
                ></ui-select>
              </div>
            </ui-grid-cell>
            <ui-grid-cell>
              <div class="demo-controls">
                ...
                <ui-select
                  v-model="phone.width"
                  :options="widthOptions"
                  @change="$grid.set('column-width', 'phone', $event)"
                ></ui-select>
              </div>
            </ui-grid-cell>
          </ui-grid>
