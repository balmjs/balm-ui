...
@use '@material/data-table/variables' with (
  ...
  $divider-color: rgba(theme-variables.prop-value(on-surface), 0.12),
  $divider-size: 1px,
  ...
  $row-text-color: rgba(theme-variables.prop-value(on-surface), 0.87),

  $sort-icon-color: rgba(theme-variables.prop-value(on-surface), 0.6),
  ...
  $shape-radius: medium,
  $stroke-size: 1px,
  $stroke-color: rgba(theme-variables.prop-value(on-surface), 0.12),
