<template>
  <div class="demo--elevation">
    <section class="hero">
      <figure :class="['demo-surface', balmUI.zSpace()]">
        <figcaption>FLAT 0dp</figcaption>
      </figure>
      <figure :class="['demo-surface', balmUI.zSpace(4)]">
    ...
    <section class="demo-surfaces">
      ...
      <figure v-for="i in 24"
        :key="i"
        :class="['demo-surface', balmUI.zSpace(i)]">
        <figcaption>{{ i }}dp (<code>mdc-elevation--z{{ i }}</code>)</figcaption>
      </figure>
    </section>
    <section>
      <div id="hover-el" :class="balmUI.zSpace(2, true)">
