  ...
  <section class="example">
    ...
    <div class="demo-controller">
      <div class="demo-controller-row">
        ...
        <input id="id0" class="demo-scroll-value" type="number" name="scrollLeft" v-model="scrollValue">
        <button type="submit" @click="$balmUI.onChange('value', +scrollValue)">Scroll</button>
      </div>
      <div class="demo-controller-row">
        <button type="button" class="demo-decrement"
          @click="$refs.scroller.increment(-50)">-50</button>
        <button type="button" class="demo-increment"
          @click="$refs.scroller.increment(+50)">+50</button>
      </div>
    </div>
  </section>
